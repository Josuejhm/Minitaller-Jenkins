      ...
      steps {
        ...
        withCredentials([usernamePassword(
          ...
          sh '''
            ...
            docker tag buscaminas-develop:${BUILD_NUMBER} ghcr.io/josuejhm/buscaminas:latest
            docker tag buscaminas-develop:${BUILD_NUMBER} ghcr.io/josuejhm/buscaminas:${BUILD_NUMBER}
            docker tag buscaminas-develop:${BUILD_NUMBER} ghcr.io/josuejhm/buscaminas:${GIT_COMMIT_SHORT}

            docker push ghcr.io/josuejhm/buscaminas:latest
            docker push ghcr.io/josuejhm/buscaminas:${BUILD_NUMBER}
            docker push ghcr.io/josuejhm/buscaminas:${GIT_COMMIT_SHORT}
          '''
        }
      }
      post {
